...
def format_stats(options, process, duration):
    ...
    syscr = stats.syscr
    syscw = stats.syscw
    return io_delay, swapin_delay, read_bytes, write_bytes, syscr, syscw
...
class IOTopUI(object):
    ...
    sorting_keys = [
        ...
        (lambda p, s: s.syscr, True),
        (lambda p, s: s.syscw, True),
